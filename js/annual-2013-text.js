...
car_text_3_en = "<p>The presence of Ugandan RTF troops in Haut Mbomou prefecture has deterred large-scale LRA attacks on communities there. However, rebel forces continue to conduct periodic small-scale looting raids that make travelling along roads or to remote fields risky and have forced thousands of civilians into long-term displacement. In early 2013, LRA rebels committed six attacks near the town of Zemio in Haut Mbomou, home to a small Ugandan RTF detachment. They then abducted 36 people just across the border from Zemio in Congo in October. LRA forces also committed a series of attacks on roads leading to the Ugandan RTF base in Djemah, most notably the abduction of 13 hunters near Derbissaka in April 2013.</p> <p><i>*All displacement data in this report is taken from the UN Office for the Coordination of Humanitarian Affairs (UN OCHA) statistics. The rise in displacement in 2013 in Haut Mbomou displacement may be due in part to other armed actors, such as Seleka fighters, in addition to LRA activity.</i></p>"
car_subtitle_3_fr = "";
car_text_3_fr = "";
