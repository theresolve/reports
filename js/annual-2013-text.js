...
background_title_3_fr = "III. à propos";
background_title_4_fr = "IV. Collecte des données";
...
lra_survival_tldr_fr = "La LRA a utilisé une gamme de stratégies de survie au cours des dernières années, y compris l'obtention de l'aide extérieure de fonctionnaires du gouvernement régional, l'agriculture et le trafic d'ivoire. Cependant, la plupart des groupes de la LRA se fondent principalement sur le pillage de petites communautés, avec des modes d'attaque qui suggèrent que la plupart des personnes enlevées sont utilisées comme porteurs à court terme.";
...
lra_survival_text_1_fr = "<p>Les commandants de la LRA ont établi un réseau sophistiqué de camps, de routes de ravitaillement, et même de collaborateurs, leurs permettant de sillonner les frontières poreuses et les forêts éloignées qui limitent les mouvements des forces UA RTF qui les poursuivent. La carte et le récit ci-dessous fournissent plus de détails sur la façon dont la LRA a survécu en 2012 et 2013, mettant en évidence leur capacité d'adaptation à des environnements politiques et écologiques divers.</p>";
...
lra_survival_map_1_fr = "Parc national de la Garamba, où la LRA braconne éléphants et autres animaux pour de l'ivoire ou de la viande";
lra_survival_map_2_fr = "Camp et champs LRA dans le parc national de la Garamba, occupés jusqu'à septembre 2013";
lra_survival_map_3_fr = "Communautés autour du Parc national de la Garamba, souvent la cible de pillages";
lra_survival_map_4_fr = "Camp et champs LRA dans le district du Bas Uélé au Congo, occupés jusqu'à septembre 2013";
lra_survival_map_5_fr = "Les autorités Centrafricaines ont fourni un groupe de la LRA avec de la nourriture et de la corde à la fin de 2013";
lra_survival_map_6_fr = "Communautés sous l'autorité de Séléka, ciblées par les pillages à grande échelle de la LRA en 2013";
lra_survival_map_7_fr = "Camp et champs LRA sur le territoire du Kafia Kingi, périodiquement occupés en 2010&ndash;2013";
lra_survival_map_8_fr = "Garnison militaire Soudanaise, qui a périodiquement alimenté la LRA en 2010&ndash;2013";
lra_survival_map_9_fr = "Marché de Songo, où les membres de la LRA ont périodiquement fait du troc pendant leurs temps au Kafia Kingi ";
...
lra_survival_safe_haven_fr = "<b>Refuge Soudanais:</b> Les forces de la LRA ont périodiquement établi des camps sur le territoire sous contrôle Soudanais du Kafia Kingi depuis 2010, avec <a href='http://www.theresolve.org/2013/04/report-sudans-renewed-support-to-the-lra/' target='_blank'>Kony lui-même restant dans le Kafia Kingi</a> à la fin de 2012 et début 2013. Les troupes Soudanaises présentes ont permis aux forces de la LRA de prendre refuge des troupes ougandaises du RTF, et les ont approvisionné avec de petites quantités de nourriture, de munitions et d'autres fournitures.";
lra_survival_negotiations_fr = "<b>Exploiter les négociations:</b> En août 2013, un groupe de la LRA dirigé par Otto Ladeere a mis en place un camp près de la ville de Nzako dans le district du Haut-Kotto en RCA et établi des contacts avec les autorités locales et l'ancien chef de la transition de l'Afrique centrale Michel Djotodia. Dans une tentative pour établir la confiance avec le groupe et encourager leur défection, Djotodia a autorisé un allié de confiance, le général Damane, <a href='http://www.theresolve.org/2013/11/the-backstory-on-konys-surrender-talks/' target='_blank'>à envoyer de la nourriture et de la corde au groupe de la LRA</a>. Damane a également autorisé un groupe national humanitaire à fournir de la nourriture et des fournitures médicales supplémentaires.  En dépit des promesses de défection, le contact a finalement été perdu avec Ladeere et les groupes de la LRA auraient quitté leurs bases.";
lra_survival_poaching_fr = "<b>Le braconnage et le trafic de l'ivoire:</b> à la mi-2011, Kony aurait ordonné aux groupes de la LRA de <a href='http://www.theresolve.org/2013/07/new-report-how-to-dismantle-the-lra-from-the-bottom-up/' target='_blank'>tuer des éléphants et lui apporter l’ivoire</a>. à la fin de 2012, le commandant en chef Binany Okumu a voyagé depuis le parc national de Garamba au Congo jusqu’au camp de Kony dans le Kafia Kingi avec pas moins de 38 défenses d’éléphants, mais on ne sait pas s’il les a toutes livrées. La destination finale de l'ivoire n'est pas claire, même si les déserteurs de la LRA déclarent qu’une partie a été échangée avec les troupes Soudanaises ou des hommes d'affaires Arabes.";
lra_survival_trading_fr = "<b>Commerce:</b> Les forces de la LRA au Kafia Kingi ont régulièrement voyagé dans des villes de marchés tels que Songo pour faire du troc et des achats de biens, mais ils avaient probablement cessé de faire cela d'ici la mi-2013. Des défecteurs récents signalent également que les groupes de la LRA utilisent parfois des intermédiaires locaux, souvent des éleveurs Mbororo, afin d’obtenir des fournitures médicales et d'autres biens.";
lra_survival_live_fr = "<b>Chasse, pêche et agriculture:</b> La LRA a utilisé un réseau de camps au Congo depuis 2005, avec des pôles dans le parc national de la Garamba et dans le district du Bas Uélé distance. Les groupes de la LRA dans ces zones pêchaient et chassaient des éléphants et des hippopotames, séchant la viande sur des grilles. Ils ont également fait pousser des récoltes comme des haricots, sim sim, et maïs. Les camps contenaient des huttes, y compris des bâtiments séparés pour le stockage de la nourriture, et ont servi de sites sécurisés pour les femmes, les enfants, et les combattants blessés.  Les forces de l'UA RTF ont <a href='http://reports.lracrisistracker.com/en/annual-2013/lra-force-capacity/' target='_blank'>détruit plusieurs de ces camps</a> en Septembre 2013, et il est difficile de savoir si les groupes de la LRA occupent actuellement des camps au Congo. Les forces de la LRA ont aussi cultivé des plantations dans le Kafia Kingi à partir de 2011 jusqu’au moins le début de 2013.";
lra_survival_resupply_fr = "<b>Routes de ravitaillement internes:</b> Les camps de la LRA au Congo ont servi de bases d'approvisionnement arrière à partir desquels de la nourriture, des munitions et d'autres fournitures obtenus au Congo ont été envoyés aux commandants de la LRA en RCA et au Kafia Kingi. Kony a expressément demandé que les batteries de motos (utilisées pour charger les appareils électronique) et l'ivoire soient envoyé aux commandants supérieurs de la LRA qui l'entourent. Les forces de la LRA utilisent un système complexe de communication codée par radios à haute fréquence (HF), de coureurs, et de points de rendez-vous prédéfinis pour coordonner le transfert des marchandises sur le vaste théâtre d'opérations du groupe.";
lra_survival_looting_fr = "<b>Pillage:</b> La plupart des groupes de la LRA continuent de s'appuyer sur des raids de pillage à petite échelle pour soutenir leurs besoins au jour le jour. Tout au long de 2013, les groupes <a href='http://reports.lracrisistracker.com/en/annual-2013/car/#mass'>ont commis leurs raids les plus violents et les plus lucratifs</a> dans les domaines de la RCA sous l'autorité des forces Séléka, sachant qu'il y avait peu de chance de représailles de la part des forces de l'UA RTF. En novembre 2013, les forces de la LRA se sont également engagées dans leurs <a href='http://invisiblechildren.com/blog/2013/11/27/south-sudan-attacks-update-from-ezo/' target='_blank'>premiers raids de pillage au Sud-Soudan</a> depuis 2011.";
...
lra_survival_text_2_fr = "<p>L'expansion des réseaux d'alerte précoce dans les zones civiles affectées par la LRA au cours des dernières années a mis en lumière les tendances dans les attaques de la LRA, y compris ce qu'ils pillent et ce qui arrive aux gens qu'ils enlèvent. Les schémas d'attaque de la LRA en RCA indiquent le groupe est encore capable de monter des attaques massives en cas de besoin, mais aucune attaque en 2013 ne ressemblait aux raids historiques de recrutement de la LRA dans lesquels ils enlevaient un grand nombre d'enfants pour être formés à long terme comme soldats, femmes, et travailleurs de camps.</p><p>Les visualisations suivantes des modèles de pillage de la LRA soulignent la transformation du groupe d'une force rebelle puissante à un groupe dont le modus operandi ressemble à celui de vulgaires bandits, à l'exception des périodiques raids à grande échelle en RCA.</p>";
...
lra_survival_visual_text_1_fr = "La nourriture qui aurait été la plus fréquemment pillée était les arachides, un aliment idéal pour les groupes de la LRA mobiles en raison de sa durabilité, haute teneur en calories et en protéines, et sa facilité de transport.";
lra_survival_visual_text_2_fr = "Vêtements, savon, et ustensiles de cuisine ont été parmi les éléments non-alimentaires les plus fréquemment rapportés comme étant volés, soulignant l'accent mis par la LRA sur l'acquisition de biens de première nécessité.";
lra_survival_visual_text_3_fr = "La LRA a enlevé quatre personnes ou moins dans la grande majorité de ses attaques en 2013, indiquant qu'ils ne sont pas en train de reconstruire leur capacité de combat, mais utilisent les personnes enlevées principalement comme porteurs pour les biens pillés après des raids à petite échelle. Dix des 13 attaques dans lesquelles la LRA a enlevé 10 personnes ou plus sont survenues dans les domaines de RCA sous l'autorité des combattants Séléka, même si ces domaines représentent seulement une petite fraction de la superficie totale de fonctionnement de la LRA.";
lra_survival_visual_text_4_fr = "La plupart des personnes enlevées par la LRA pour lesquels des données pertinentes étaient disponibles étaient des adultes et la plupart ont passé moins de 30 jours avec la LRA. Cette tendance est une indication qu'ils ont été utilisés principalement comme porteurs avant de s’ échapper ou d’être libéré.";
...
lra_survival_next_fr = "<i>Suivant:</i> Capacité de force de la LRA <i class='fa fa-chevron-right'></i>";
...
force_capacity_tldr_fr = "Les forces de l'UA RTF ont réussi à détruire plusieurs camps de la LRA et à tuer des commandants clés en 2013, tandis que 16 combattants ougandais de la LRA et 62 femmes et enfants captifs à long terme ont fait défection ou se sont échappés. Malgré cela, Kony conserve un contrôle ferme sur la structure de commandement du groupe et de ses environs 220 combattants au total.";

force_capacity_subtitle_1_en = "I. The LRA loses safe havens and key commanders"
force_capacity_text_1_en = "<p>In January 2013, Ugandan RTF troops in CAR <a href='http://blog.invisiblechildren.com/2013/01/21/top-lra-commander-killed-in-combat/' target='_blank'>killed Binany Okumu</a>, a Kony loyalist entrusted with ivory deliveries from Congo. In March, Ugandan RTF troops circumvented a Sudanese military garrison to destroy an LRA base in Kafia Kingi, missing Kony just days after he left for CAR. The Seleka coup in CAR then forced the AU RTF to put operations on hold, giving Kony new respite.</p><p>In September, operations gained new momentum as South Sudanese and Congolese RTF forces conducted their first offensive action against the LRA, utilizing substantial US military logistical and intelligence support. South Sudanese troops destroyed several LRA bases and fields in Congo's Garamba National Park, while Congolese troops destroyed an LRA base in Bas Uele district, including several acres of fields. In November, Ugandan troops <a href ='http://blog.invisiblechildren.com/2013/12/02/more-on-the-recent-lra-ambush-in-central-african-republic/' target='_blank'>killed LRA commander Samuel Kangul</a> and recovered supplies his group had attained from Central African authorities near Nzako. However, the <a href='http://reports.lracrisistracker.com/en/annual-2013/background/'>outbreak of civil war in South Sudan</a> and <a href='http://reports.lracrisistracker.com/en/annual-2013/background/'>deteriorating security in CAR</a> have once again put future AU RTF operations in jeopardy.</p> <p>Sixteen Ugandan LRA combatants defected in 2013. Most notably, <a href='http://blog.invisiblechildren.com/2013/12/10/breaking-news-largest-lra-defection-since-2008/' target='_blank'>senior LRA commander Lt. Col. Okello Okutti surrendered</a> in December in CAR with five other Ugandan combatants and 13 others. Nine of the Ugandan combatants who defected in 2013 reported being influenced by Come Home defection messaging, including Okutti's group. They cited Acholi-language programs run on the Uganda Broadcasting Corporation (UBC) station <a href='http://blog.invisiblechildren.com/2013/09/20/how-opondo-escaped-the-lra-after-15-years/' target='_blank'>as particularly influential</a> in encouraging them to defect.</p>"
force_capacity_text_1part2_en = "<p>In total, the LRA lost at least 32 Ugandan male combatants in 2013, with unconfirmed reports indicating Ugandan RTF troops killed or captured approximately eight more. Using baseline estimates from its 2013 report <i><a href='http://www.theresolve.org/2013/07/new-report-how-to-dismantle-the-lra-from-the-bottom-up/' target='_blank'>Loosening Kony's Grip</a></i>, The Resolve estimates that by the end of 2013 the LRA contained approximately 220 combatants, including an estimated 160&ndash;168 Ugandan officers and fighters and 50 non-Ugandan low-level fighters.</p>"
force_capacity_subtitle_1_fr = "I. La LRA perd ses lieux de refuges et des commandants clés";
force_capacity_text_1_fr = "<p>En janvier les troupes RTF Ougandaises en RCA ont <a href='http://blog.invisiblechildren.com/2013/01/21/top-lra-commander-killed-in-combat/' target='_blank'>tué Binany Okumu</a>, un loyaliste de Kony chargé des livraisons d'ivoire venant du Congo. En mars, les troupes RTF Ougandaises ont contourné une garnison militaire Soudanaise pour détruire une base de la LRA dans le Kafia Kingi, manquant Kony de quelques jours après son départ pour la RCA. Le coup Séléka en RCA a forcé l'UA RTF à mettre ses opérations en attente, donnant Kony nouveau répit.</p><p>En septembre, les opérations ont pris un nouvel élan alors que les forces RTF Sud-Soudanaises et Congolaises ont mené leur première action offensive contre la LRA en utilisant un important soutien logistique et en renseignement de l’armée Américaine. Les troupes Sud-Soudanaises ont détruit plusieurs bases et champs de la LRA dans le parc national de Garamba au Congo, tandis que les troupes Congolaises ont détruit une base de la LRA dans le district du Bas Uélé, y compris plusieurs hectares de champs. En novembre, les troupes Ougandaises <a href ='http://blog.invisiblechildren.com/2013/12/02/more-on-the-recent-lra-ambush-in-central-african-republic/' target='_blank'>ont tué le commandant LRA Samuel Kangul</a> et récupéré des biens que son groupe avait obtenu des autorités de RCA près de Nzako. Cependant, le <a href='http://reports.lracrisistracker.com/en/annual-2013/background/'>déclenchement de la guerre civile au Sud-Soudan</a> et <a href='http://reports.lracrisistracker.com/en/annual-2013/background/'>la détérioration de la sécurité en RCA</a> ont une fois de plus mis les futures opérations de l'UA RTF en danger.</p><p>Seize combattants ougandais de la LRA ont fait défection en 2013. Plus particulièrement, <a href='http://blog.invisiblechildren.com/2013/12/10/breaking-news-largest-lra-defection-since-2008/' target='_blank'>le commandant supérieur de la LRA lieutenant-colonel Okello Okutti s’est remis</a> en décembre en RCA avec cinq autres combattants Ougandais et 13 autres. Neuf des combattants Ougandais qui ont fait défection en 2013 ont déclaré être influencé par des messages de défection ‘Come Home’, y compris le groupe de Okutti.  Ils ont cité les programmes de langue Acholi qui passent sur la station de la ‘Uganda Broadcasting Corporation’ (UBC) <a href='http://blog.invisiblechildren.com/2013/09/20/how-opondo-escaped-the-lra-after-15-years/' target='_blank'>comme particulièrement influents</a> pour les encourager à faire défection.</p>";
force_capacity_text_1part2_fr = "<p>Au total, la LRA a perdu au moins 32 combattants hommes Ougandais en 2013, avec des rapports non confirmés indiquant que les troupes RTF ougandaises en ont tué ou capturé environ huit de plus. Utilisant des estimations de référence venant de son rapport de 2013 <i><a href='http://www.theresolve.org/2013/07/new-report-how-to-dismantle-the-lra-from-the-bottom-up/' target='_blank'>Desserrer la poigne de Kony</a></i>, Resolve estime que la LRA contenait environ 220 combattants, dont environ 160-168 officiers et combattants Ougandais et 50 combattants  non-Ougandais de bas niveau, à la fin de 2013.</p>";
...
lra_force_capacity_map_1_fr = "Janvier: Les troupes Ougandaises tuent l’officier LRA Binany Okumu après qu’il aurait livré de l’ivoire à Kony";
lra_force_capacity_map_2_fr = "Février: Les troupes Ougandaises découvrent une cache d’ivoire de la LRA au nord de Djemah, RCA";
lra_force_capacity_map_3_fr = "Début 2013: Officier de la LRA Otto Agweng exécuté sur les ordres de Kony";
lra_force_capacity_map_4_fr = "Avril: Quatre combattants Ougandais de la LRA font défection à Obo, RCA";
lra_force_capacity_map_5_fr = "Juillet: Des chasseurs Sud-Soudanais tuent l’officier LRA supérieur Thomas Odano";
lra_force_capacity_map_6_fr = "Août: Un combattant Ougandais de la LRA fait défection près du Parc national de la Garamba";
lra_force_capacity_map_7_fr = "Septembre: Les troupes Sud-Soudanaises détruisent un camp de la LRA dans le Parc national de la Garamba";
lra_force_capacity_map_8_fr = "Septembre: Les troupes Congolaises détruisent un camp de la LRA dans le district du Bas Uélé au Congo";
...
lra_force_capacity_map_10_fr = "Décembre: L’officier de la LRA Okello Okutti et cinq autres combattants de la LRA font défection";
lra_force_capacity_map_11_fr = "Les troupes Ougandaises ont attaqué les camps de la LRA au Kafia Kingi en 2013, tuant au moins six combattants de la LRA";
...
force_capacity_text_2_fr = "<p>Le fondateur de la LRA Joseph Kony reste le leader incontesté du groupe, mais en dessous de lui la hiérarchie de commande est en constante évolution. Kony fréquemment promeut ou rétrograde des officiers, souvent sans considération de leur grade militaire conventionnel, afin de veiller à ce qu'aucun commandant n’atteigne assez d'influence pour menacer sa poigne de fer sur la LRA. Au cours des dernières années, Kony a <a href='http://www.lracrisistracker.com/command/evolution' target='_blank'>tendance à favoriser les commandants les plus jeunes</a>. Beaucoup de ces commandants ont été enlevés comme jeunes garçons depuis le nord de l'Ouganda, et ont ensuite servi comme ses gardes du corps et lui demeurent très fidèles. Kony aurait également habilité plusieurs de ses fils, y compris Salim, un jeune officier ambitieux élevé dans la brousse. Pendant ce temps, Kony a rétrogradé de nombreux commandants plus âgés qui ont eu une expérience militaire avant de rejoindre la LRA, bien que son fidèle second de commande, Okot Odhiambo, conserve une position de grande influence.</p><p>Les tentatives de Kony pour maintenir son emprise sur le pouvoir sont venus à risques et coûts importants. Il a autorisé une plus grande utilisation des radios à haute fréquence (HF) afin de maintenir les communications avec les commandants de la LRA éloignés, malgré le danger que les forces militaires Ougandaises vont utiliser les interceptions de signaux pour traquer les groupes de la LRA. Kony aurait également <a href='http://www.theresolve.org/2013/07/new-report-how-to-dismantle-the-lra-from-the-bottom-up/' target='_blank'>ordonné l'exécution d'au moins quatre officiers de la LRA</a> pour désobéissance à la fin de 2012 et début 2013. L'exécution la plus notable était celle d’Otto Agweng, autre fois l'un des exécutants les plus fiables et les plus craints de Kony, après qu’il ait violé une femme captive contre les ordres de Kony.</p>";
force_capacity_text_2_caption_fr =  "<p>Les mesures disciplinaires de Kony, comme ses décisions sur la hiérarchie de commande, peuvent être imprévisibles. En 2012, le demi-frère David Olanya de Kony a également engagé la colère de Kony pour avoir couché avec une femme captive sans autorisation. Cependant, Kony l’a seulement rétrogradé, peut-être par respect pour ses liens familiaux. Dominic Ongwen a également échappé à la force de la justice de Kony, probablement en raison de ses liens familiaux à Kony et sa bravoure au combat.</p><p>Cartographier la structure de commandement de la LRA est extrêmement difficile, étant donné le manque d'accès au groupe et le remaniement constant des responsabilités par Kony.  Ce graphique suit les destins de 101 officiers Ougandais identifiés qui ont été des membres confirmés de la LRA à partir de 2009, donnant un aperçu de la façon dont la structure de commandement a changé depuis lors.</p>"
...
force_capacity_subtitle_3_fr = "III. Les femmes et enfants captifs à long terme rentrent chez eux";
force_capacity_text_3_fr = "<p>Bien que les officiers Ougandais hommes monopolisent le pouvoir au sein de la LRA, ils dépendent sur les femmes et les enfants détenus en captivité à long terme pour survivre au jour le jour. Les femmes et les enfants mettent en place et démontent les camps, transportent les essentiels de campement lorsque les groupes se déplacent, cuisinent, et accomplissent d'autres tâches essentielles. Beaucoup de femmes et de filles sont contraintes à des relations sexuelles avec des officiers masculins et les combattants. Parfois les femmes participent au pillage des raids, et quelques-unes ont été promues au niveau d’officier.</p><p>Au début de 2013, la LRA avait environ 250 femmes et enfants dans ses rangs, y compris les captifs à long terme qui avaient été avec la LRA pour plus de six mois ainsi que les personnes enlevées à court terme. Soixante-deux femmes et enfants détenus en captivité à long terme ont échappé à la LRA en 2013, dont la majorité (32) étaient des enfants enlevés à l'origine de la RCA, du Congo, ou du Sud-Soudan. Dix femmes et enfants Ougandais captifs à long terme ont échappé à la LRA en 2013, une légère diminution des 13 qui se sont échappés en 2012. Près de 75% des 62 rapatriés ont été <a href='http://blog.invisiblechildren.com/2013/04/01/update-on-the-28-women-and-children-who-escaped-the-lra-last-week/' target='_blank'>volontairement libérés par la LRA</a> ou se sont échappés avec un combattant de la LRA, ce qui indique que la LRA peut avoir du mal à nourrir les femmes et les enfants et peut avoir moins d'utilité pour eux alors que le nombre de combattants diminue. Seulement sept des 62 rapatriés se sont échappés seuls, ce qui suggère que les femmes et les enfants ont des informations, possibilités et incitations à s'échapper insuffisantes.</p>";
...
congo_tldr_fr = "La fréquence des attaques de la LRA dans le nord-est du Congo a lentement diminué au cours des dernières années, mais elle continue à cibler les collectivités à l'ouest et au sud du parc national de la Garamba. Les enlèvements et assassinats de la LRA ont baissé à un rythme beaucoup plus rapide que les attaques, ce qui rend la distinction de l'activité de la LRA par rapport aux attaques par d'autres groupes armés dans la région plus difficile.";
...
congo_text_1_fr = "à partir de 2008&ndash;2010, la LRA a été l'un des <a href='http://www.hrw.org/news/2010/03/28/dr-congo-lord-s-resistance-army-rampage-kills-321' target='_blank'>groupes les plus violents au Congo</a>, tuant plus de 2.300 civils et enlevant près de 2.500 autres. Les enlèvements de la LRA au Congo ont chuté de 64% et les homicides de 94% au cours des trois prochaines années, une chute spectaculaire qui reflète la capacité rétrécissant du groupe. Cependant, les attaques de la LRA ont chuté de seulement 12% sur la même période de temps, ce qui indique que la diminution du nombre d'enlèvements et de meurtres était en partie le résultat d'une décision stratégique par les dirigeants de la LRA d’ordonner aux groupes de réduire les attaques extrêmement violentes qui attirent l'attention internationale.";
...
congo_text_2_fr = "<p>Une grande majorité des civils dans les zones du Congo touchées par la LRA dépend de l'accès aux champs, aux forêts et aux rivières pour soutenir ou compléter leurs moyens de subsistance. De nombreux civils se rendent aussi dans les marchés locaux pour vendre leur prime ou participer dans le petit commerce. Les attaques de la LRA rendent très dangereux de s'engager dans ces moyens de subsistance essentiels, mais beaucoup de gens n'ont pas d'autre choix que de prendre le risque.</p> <p>Les troupes de l'armée Congolaise et de la mission de maintien de la paix des Nations Unies au Congo (MONUSCO) sont déployées dans toute la région, mais font peu autre que dissuader les raids de la LRA sur les grandes villes. De nombreux civils utilisent des techniques d'auto-protection, comme les voyages en groupes le long des routes et aux champs, afin de réduire leur vulnérabilité aux attaques de la LRA.</p>";
...
congo_subtitle_3_fr = "III. Tactiques de groupes armés convergent dans le nord du Congo";
congo_text_3_fr = "<p>Les taux élevés de violences de la LRA dans le nord-est du Congo ont contribué à déstabiliser une région déjà en proie à la mauvaise gouvernance et à l'anarchie, ce qui contribue à un environnement qui encourage une variété d'acteurs armés à s'en prendre à des civils. En particulier, les forêts denses du parc national de la Garamba et le gibier sauvage lucratif attirent les combattants de la LRA, des soldats Congolais voyous, des braconniers locaux, et des braconniers Soudanais et Sud-Soudanais lourdement armés. Utilisant la forêt comme refuge, ces groupes armés attaquent les voyageurs et les villages sur les routes allant ouest et sud du parc.</p><p>Ces groupes armés utilisent souvent des tactiques semblables à celles de la LRA, parfois intentionnellement, ce qui rend difficile pour les acteurs de la protection <a href='http://reports.lracrisistracker.com/en/annual-2013/background/#methodology' target= '_blank'>d’identifier les auteurs</a>. Cette dynamique a été exacerbée par la décision de la LRA de réduire ses attaques signatures de raids d'enlèvements et de massacres à grande échelle. Dans les zones du Congo touchées par la LRA en 2013, le ratio des attaques de la LRA à celles dans lesquelles le groupe armé a été non identifié (indiquant que l'auteur pourrait être la LRA, des bandits, des braconniers, des soldats Congolais voyous, ou d'autres groupes armés) était de 125 à 44, similaire à la proportion de 223 à 86 en 2012.</p>";
...
congo_map_title_fr = "Les attaques menées par les groupes armés non identifiés vs LRA | <i>2013</i>";
congo_visual_caption_2_fr = "<i>*Ce graphique donne un aperçu de la façon dont les attaques de la LRA menacent les civils Congolais engagés dans des activités de subsistance en 2013, mais il sous-estime probablement chaque catégorie en raison du manque d'informations détaillées disponibles pour de nombreuses attaques.</i>";
